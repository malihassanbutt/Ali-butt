...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐀𝐥𝐢 𝐁𝐮𝐭𝐭',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐀𝐥𝐢 𝐁𝐮𝐭𝐭;𝐃𝐞𝐧𝐳𝐨 𝐔𝐜𝐡𝐢𝐰𝐚;244935469526;https://i.imgur.com/aKpPk78.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝐀𝐥𝐢 𝐁𝐮𝐭𝐭;𝐃𝐞𝐧𝐳𝐨 𝐔𝐜𝐡𝐢𝐰𝐚;https://i.imgur.com/aKpPk78.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐀𝐥𝐢 𝐁𝐮𝐭𝐭;𝐃𝐞𝐧𝐳𝐨 𝐔𝐜𝐡𝐢𝐰𝐚 ' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '244935469526',
       DEBUG: DEBUG
};
